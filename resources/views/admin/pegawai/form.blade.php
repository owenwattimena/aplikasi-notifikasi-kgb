                        ...
                        <form action="#" class="form-horizontal" method="POST">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="nama" value="{{ isset($data) ? $data->nama : '' }}" class="form-control" id="inputNama" placeholder="[Nama Lengkap]">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="nip" value="{{ isset($data) ? $data->nip : '' }}" class="form-control" id="inputNIP" placeholder="[Nomor Induk Pegawai]">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputGolRuang" class="col-sm-2 control-label">Gol. Ruang</label>
                                    <div class="col-sm-10">
                                        <select name="id_gol_ruang" class="form-control gol-ruang js-states" style="width: 100%;" id="inputGolRuang">
                                            <option></option>
                                            @foreach ($gol_ruang as $item)
                                                <option value="{{$item->id}}">{{$item->gol_ruang}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sk_terakhir" value="{{ isset($data) ? $data->sk_terakhir : '' }}" class="form-control" id="inputSkTerakhir" placeholder="[SK Terakhir]">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="tmt" value="{{ isset($data) ? $data->tmt : '' }}" class="form-control" id="inputTMT" placeholder="[Nomor/Tanggal/TMT]">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="id_jabatan" class="form-control jabatan js-states" style="width: 100%;" id="inputJabatan">
                                            <option></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" name="tmt_berkala_akan_datang" value="{{ isset($data) ? $data->tmt_berkala_akan_datang : '' }}" class="form-control" id="inputTmtAkanDatang" placeholder="[Nomor/Tanggal/TMT]">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputUnitKerja" class="col-sm-2 control-label">Unit Kerja</label>
                                    <div class="col-sm-10">
                                        <select name="id_unit_kerja" class="form-control unit-kerja js-states" style="width: 100%;" id="inputUnitKerja">
                                            <option></option>
